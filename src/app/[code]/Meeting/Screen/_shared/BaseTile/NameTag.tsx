...
export default function NameTag({ id, name }: NameTagProps) {
  ...
  return (
    <div className={cn('absolute bottom-0 left-0 z-2 px-2 pb-2')}>
      <div
        className={cn(
          'flex h-8 items-center justify-start gap-2 overflow-hidden rounded-2xl pr-3 pl-2',
          isHandsUp ? 'animate-expand-pill bg-success-subtle origin-bottom' : 'bg-transparent',
        )}
      >
