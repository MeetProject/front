  ...
  return (
    <>
      ...
      <div className='flex items-center gap-2 max-[775px]:hidden'>
        <button
          className='border-outline-dark flex h-7.5 items-center justify-center gap-1 rounded-3xl border px-3'
          type='button'
        >
          <Icon.Blur className='fill-on-surface' height={20} width={20} />
          <p className='text-on-surface text-sm'>백그라운드 흐리게 처리</p>
        </button>
        <button className='border-outline-dark h-7.5 rounded-3xl border px-3' type='button'>
