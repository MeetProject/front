...
export default function ParticipantCard({ color, isMe, name, option, userId }: ParticipantCardProps) {
  return (
    <div className='my-3 flex items-center justify-between'>
      <div className='flex flex-1 items-center gap-4'>
        <Profile className='size-8 text-[16px]' color={color} name={name} />
      ...
      {option && (
        <div className='flex items-center'>
          <div className='flex size-12 items-center justify-center'>
            {option.audio && <MicStatus userId={userId} />}
          </div>
