    ...
    <>
      {permission[type] !== 'prompt' && (
        <div className='relative flex items-center'>
          <button
            className={`relative flex items-center justify-center border border-solid shadow-sm ${!deviceEnable[type] && permission[type] === 'granted' ? 'border-danger-base bg-danger-base' : 'border-white'} size-14 rounded-full max-[400px]:size-10`}
            type='button'
